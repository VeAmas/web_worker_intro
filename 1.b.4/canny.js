...
(function () {
  ...
  GrayImageData = (function () {
    ...
    GrayImageData.prototype.loadCanvas = function (rawdata) {
      var b, d, g, i, r, x, y, _i, _len;
    ...
    GrayImageData.prototype.drawOn = function () {
      return this.toImageDataArray();
    };
  ...
  CannyJS.canny = function (rawdata, cw, ch, ht, lt, sigmma, kernelSize) {
    var imgData;
    if (ht == null) {
      ht = 100;
    }
    ...
    imgData = new GrayImageData(cw, ch);
    imgData.loadCanvas(rawdata);
    self.blur = CannyJS.gaussianBlur(imgData, sigmma, kernelSize);
    self.sobel = CannyJS.sobel(blur);
    self.nms = CannyJS.nonMaximumSuppression(sobel);
    return CannyJS.hysteresis(nms, ht, lt);
  };

  self.CannyJS = CannyJS;

  self.GrayImageData = GrayImageData;
}).call(this);
